...
(function() {
  ...
  SubjectViewer = (function(superClass) {
    ...
    SubjectViewer.prototype.createMarkingSurface = function() {
      ...
      this.markingSurface.on('add-tool', (function(_this) {
        return function(tool) {
          var color, property, ref, ref1, ref2, value;
          tool.attr(_this.FROM_CURRENT_TASK, true);
          color = (ref = _this.toolOptions) != null ? ref.color : void 0;
          if (color != null) {
            tool.el.style.color = color;
          }
          tool.unit = _this.toolOptions.unit;
          tool.upp = _this.toolOptions.upp;
          if ((ref1 = tool.controls) != null) {
            ref1.details = _this.toolOptions.details;
          }
          if (_this.toolOptions != null) {
            ref2 = _this.toolOptions;
    ...
    SubjectViewer.prototype.loadSubject = function(subject, callback) {
      var fn, heights, i, imgSrc, j, len, ref, subjectImages, widths;
      ...
      widths = [];
      heights = [];
      subjectImages = (ref = this.subject.location.standard) != null ? ref : this.subject.location;
    ...
    SubjectViewer.prototype.setTaskIndex = function(taskIndex) {
      var j, ref, results, tool;
      this.taskIndex = taskIndex;
      ref = this.markingSurface.tools;
      results = [];
